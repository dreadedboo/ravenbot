...
- livesplit commands (!pb, !bpt, !sob, !livesplit <game/title/setup/connect>) NOTE: game title and setup only work with
  aop-runs' fork of livesplit at the moment
- followage command
...
- discord bot
- emote sync with twitch extensions
